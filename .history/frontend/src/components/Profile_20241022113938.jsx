        ...
        <div className={`right-panel ${!userType ? 'full-width' : ''}`}>
          <div className="profile-header">
            <div className='profile-picture-container'>
              ...
              <input type="file" onChange={handleFileChange} accept="image/*" className="form-control my-3" />
              <button onClick={handleFileUpload} className="btn btn-sm btn-primary mt-2">Upload</button>
            </div>
          </div>
          {/* Navigation Tabs */}
